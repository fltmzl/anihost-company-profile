...
export default function HostingPricingPlanCard({ headerTitle, features, footerDescription, headerDescription, price, pricingPeriod, variant = "secondary" }: HostingPricingPlanCardProps) {
  return (
    <div className="w-full md:max-w-sm rounded-2xl overflow-hidden bg-gradient-to-r from-blue-700 to-blue-500 border duration-300 border-slate-700 hover:border-blue-400 hover:scale-105 hover:shadow-2xl">
      ...
      <div className={twMerge("text-center px-5 py-6", variant === "primary" ? "bg-gradient-to-br from-blue-700 to-blue-500" : "bg-slate-800 ")}>
        <h4 className={twMerge("text-3xl lg:text-5xl font-bold", variant === "primary" ? "text-white" : "text-blue-500")}>${price}</h4>
