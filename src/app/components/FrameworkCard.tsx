...
export default function FrameworkCard({ title, iconImage, animationDelay }: FrameworkCardProps) {
  return (
    <div className="space-y-2 text-center" data-aos="fade-up" data-aos-delay={animationDelay}>
      <div className="bg-slate-700 rounded-full mx-auto size-20 grid place-content-center">
